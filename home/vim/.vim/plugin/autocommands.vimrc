...
autocmd! FileType typescript.tsx nnoremap <leader>F :% !prettier %<CR>
...
autocmd! BufAdd *.spec.ts nnoremap <leader>t :RunJestTest<CR>
autocmd! BufAdd *.spec.tsx nnoremap <leader>t :RunJestTest<CR>
